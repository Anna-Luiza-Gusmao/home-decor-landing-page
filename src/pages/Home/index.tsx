	...
	return (
		<>
			<Helmet prioritizeSeoTags>
				<title>Home</title>
				<meta name="Home" content="Página Home que contém a prévia dos serviços oferecidos pela homedecor." />
			</Helmet>
			<HomeContainer>
					...
					<TestimonialsBox>
						{customerTestimonials.map((item) => (
							<TestimonialContent key={item.id}>
								<img
									src={item.pathCostumerImage}
									alt={`Imagem do cliente ${item.customerName}`}
									loading="lazy"
								/>
